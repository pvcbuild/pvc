...
namespace ScriptCs
{
    public class PvcScriptServicesBuilder : ServiceOverrides<IScriptServicesBuilder>, IScriptServicesBuilder
    {
        ...
        public PvcScriptServicesBuilder(IConsole console, ILog logger, IRuntimeServices runtimeServices = null)
        {
            _initializationServices = new PvcInitializationServices(logger);
